    ...
    <FooterWrapper>
      <footer style={styles.footer}>
        <div style={styles.container}>
          ...
          {/* Enlace a sucursales y correo */}
          <div style={styles.column}>
            <h3 style={styles.title}>Sucursales</h3>
            <p style={styles.linkText}>
              <Link to="/sucursales" style={styles.link}>Ver todas las sucursales</Link>
            </p>
            <br />
            ...
            <StyledWrapper>
              <ul className="example-2">
                <li className="icon-content">
                  <a data-social="whatsapp" aria-label="Whatsapp" href="https://wa.me/525575110551" target="_blank" rel="noopener noreferrer">
                ...
                <li className="icon-content">
                  <a data-social="facebook" aria-label="Facebook" href="https://www.facebook.com/share/19nvSzrxNV/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">
                    <div className="filled" />
                    <svg xmlSpace="preserve" viewBox="0 0 24 24" className="bi bi-facebook" fill="currentColor" height={24} width={24} xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="icon-content">
                  <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/elchel_oficial/" target="_blank" rel="noopener noreferrer">
                    <div className="filled" />
